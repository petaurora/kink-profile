...
export const sceneThemeDefinitions: readonly SceneThemeDefinition[] = [
  ...
  },
  {
    id: "care",
    label: "Care",
    description: "Nurturing, soothing, support, praise, and deliberate caretaking.",
    family: "activity",
    mappings: [
      { kind: "signal", id: "care_receiving", weight: 1 },
      { kind: "signal", id: "care_giving", weight: 1 },
      { kind: "signal", id: "praise_approval", weight: 0.5 },
      { kind: "dynamic_mode", id: "nurtured_play", weight: 0.75 },
  ...
  },
  {
    ...
    mappings: [
      ...
      { kind: "dynamic_mode", id: "nurtured_play", weight: 0.5 },
  ...
  },
  {
    id: "protocol",
    label: "Protocol",
    description: "Formal expectations, ritual, structure, and intentional behavioral framing.",
    family: "dynamic_mode",
    mappings: [
      { kind: "dynamic_mode", id: "protocol_mode", weight: 1 },
      { kind: "signal", id: "structure", weight: 1 },
      { kind: "signal", id: "ritual_significance", weight: 0.9 },
  ...
  },
  {
    ...
    description: "Teasing, pushback, interactive challenge, and negotiated resistance.",
    family: "dynamic_mode",
    mappings: [
  ...
  },
  {
    ...
    mappings: [
      ...
      { kind: "dynamic_mode", id: "nurtured_play", weight: 0.9 },
      { kind: "facet", id: "care_nurture", weight: 1 },
    ],
  },
  {
    id: "structured",
    label: "Structured",
    description: "Clear expectations, deliberate pacing, rules, and organized progression.",
    family: "vibe",
    mappings: [
      { kind: "signal", id: "structure", weight: 1 },
  ...
  },
  {
    id: "intense",
    label: "Intense",
    description: "Physically or emotionally strong play with more challenge and edge.",
    family: "vibe",
    mappings: [
