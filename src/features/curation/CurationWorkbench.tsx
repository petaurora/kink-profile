    ...
    <section className="curation-workbench">
      <div className="curation-hero panel">
        <div>
          ...
          <p>
            Review the app itself without touching your actual profile. Every decision
            here is a local proposal until you export it and apply it through the repo
            workflow.
          </p>
        </div>
      ...
      {currentEntry ? (
          ...
          <div className="curation-card-footer curation-card-nav">
            ...
            <button
              ...
              onClick={() => {
                ...
                const next =
                  filteredEntries[(index + 1) % filteredEntries.length];
                setSelectedKey(entryKey(next));
              }}
            >
              Next
        ...
        <div className="curation-empty panel">
          ...
          <p>
            Change the filters, or switch to Reviewed if you already chewed through
            everything here. 🫡
          </p>
        </div>
      )}
      ...
      {reviewedCount > 0 && (
        <div className="curation-danger-zone panel">
          <div>
            ...
            <p>
              This only clears M16 proposal/review state. It does not touch your profile,
              rankings, scenes, rewards, punishments, or quiz answers.
            </p>
          </div>
          <button
            className="secondary"
