...
6. [M6 Catalog Integration](m6-catalog-integration.md)  
   The in-progress M6 contract: C1 stable IDs implemented; catalog mappings, explicit preference state, ranking hardening, and the M7 boundary remain.
...
8. [Scoring & Taxonomy Model](scoring-model.md)  
   The reusable scoring architecture behind the core quizzes and catalog affinity.

9. [Overall Profile Aggregation](overall-profile-aggregation.md)  
...
11. [Reference Data](../reference/README.md)  
