...
14. [M11 This-or-That Ranking History & Movement](m11-ranking-history-movement.md)  
...
| How should repeat This-or-That runs and rank movement work? | [M11 This-or-That Ranking History & Movement](m11-ranking-history-movement.md) |
...
If pairwise catalog ranking behavior changes, update the this-or-that ranking spec. If temporal ranking-run/history behavior changes, update the M11 ranking-history spec.  
