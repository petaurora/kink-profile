...
The storage schema supports future receiving/giving overrides because many catalog concepts are directional. The implemented C3 editor changes the general/overall state contextually while preserving directional fields in the storage contract.
